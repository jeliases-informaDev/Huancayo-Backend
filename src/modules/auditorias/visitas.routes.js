...
import { idParams, evidenciaParams, listQuery, evidenciaPresignBody, visitaCreateBody, ubicacionBody } from '../../validation/schemas.js';
...
router.get('/', roleMiddleware(OPERATIONAL_MANAGERS), validate({ query: listQuery }), controller.listar);
